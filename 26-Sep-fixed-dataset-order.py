...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('miniset_fixed_data_set_sep26.txt', mode='a'),
        ...
        for device_id in selected_devices:
            ...
            for label in range(10):  # الفئات من 0 إلى 9
                ...
                if not available_indices:
                    ...
                    logging.warning(f"Class {label}: all samples distributed, resetting indices")
                ...
                if num_samples <= 0:
                    logging.warning(f"Not enough samples for class {label} for device {device_id}")
                    continue
    ...
    def select_action(self, state):
        ...
        if random.random() < self.epsilon:
            ...
            with torch.no_grad():
                ...
                with open("scores_output_MNISET.txt", "a") as f:
