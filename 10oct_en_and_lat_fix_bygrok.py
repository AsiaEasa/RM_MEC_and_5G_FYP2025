...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('fixed_en_lat_oct10.txt', mode='a'),
...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.savefig('energy per episode_fixed_en_lat_oct10.txt.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig('Latency per episode_fixed_en_lat_oct10.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig('Accuracy per iteration1_fixed_en_lat_oct10.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig('Accuracy per for 160 iteration1 _fixed_en_lat_oct10.png')
    plt.close()
