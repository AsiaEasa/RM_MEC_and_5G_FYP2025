...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('simulation_log_16th_2.txt', mode='a'),
...
# Parameters
# LR = .001 , lr = .0001 , NUM_EPISODES = 35 , epoch = 10
#  حساب الدقه الكليه
...
if __name__ == "__main__":
    ...
    for episode in range(NUM_EPISODES):
        ...
        episode_accuracies.append(accuracy)  # تخزين الدقة النهائية للحلقة
